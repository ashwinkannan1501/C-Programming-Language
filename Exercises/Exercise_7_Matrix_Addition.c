...
void main()
{
    ...
    short first_matrix[rows][columns], second_matrix[rows][columns], addition_matrix[rows][columns];
    printf("First Matrix \n");
    ...
    for (unsigned short row = 0; row < rows; row ++)
    {
        for (unsigned short column = 0; column < columns; column ++)
        {
            addition_matrix[row][column] = first_matrix[row][column] + second_matrix[row][column];
        }
    }
    ...
    for (unsigned short row = 0; row < rows; row ++)
    {
        for (unsigned short column = 0; column < columns; column ++)
        {
            printf("%hd\t", addition_matrix[row][column]);
        }
        printf("\n");
    }
}
